/*
 * File: JSELBooleanObjectTest.java
 *
...
public class JSELBooleanObjectTest {
    ...
    public void toPrimitive() {
        ...
        //not equals because we do a numeric comparison:
        // true == "true" => 1 == NaN
        assertNotEquals(JSELBoolean.TRUE,
                trueObject.toPrimitive(GetHint.STRING));
        assertEquals(new JSELString("true"),
                trueObject.toPrimitive(GetHint.STRING));

        assertEquals(JSELBoolean.FALSE,  falseObject.toPrimitive(null));
        assertEquals(JSELBoolean.FALSE,
                falseObject.toPrimitive(GetHint.NUMBER));
        // again, is false == 'false' ? No, it's not
        assertNotEquals(JSELBoolean.FALSE,
                falseObject.toPrimitive(GetHint.STRING));
        assertEquals(new JSELString("false"),
                falseObject.toPrimitive(GetHint.STRING));
    }
    ...
    public void toObject() {
        ...
        assertSame(falseObject, falseObject.toObject());
