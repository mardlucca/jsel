/*
 * File: ToExponentialFunction.java
 *
...
public class ToExponentialFunction extends JSELFunction {
    public static final String NAME = "toExponential";
    private static final int MAX_DIGITS = 20;

    public ToExponentialFunction() {
    ...
    public JSELValue call(
        ...
        return new JSELString(
                String.format("%." + lFractionDigits + "e", lNumber));
    }
}
