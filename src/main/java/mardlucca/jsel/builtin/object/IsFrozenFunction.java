...
public class IsFrozenFunction extends JSELFunction {
    public static final String NAME = "isFrozen";

    public IsFrozenFunction() {
    ...
    public JSELBoolean call(JSELValue aInThis, List<JSELValue> aInArguments,
        ...
        for (String lName : lObject.getOwnPropertyNames()) {
            ...
            if (lDescriptor.isConfigurable() || lDescriptor.isWritable()) {
                return JSELBoolean.FALSE;
            }
        }

        return lObject.isExtensible() ? JSELBoolean.FALSE : JSELBoolean.TRUE;
    }
}
