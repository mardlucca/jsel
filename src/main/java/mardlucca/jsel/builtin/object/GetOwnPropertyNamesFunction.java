/*
 * File: GetOwnPropertyNamesFunction.java
 *
...
public class GetOwnPropertyNamesFunction extends JSELFunction {
    public static final String NAME = "getOwnPropertyNames";

    public GetOwnPropertyNamesFunction() {
    ...
    public JSELObject call(JSELValue aInThis, List<JSELValue> aInArguments,
        ...
        int lIndex = 0;
        for (String lName : lArgument.toObject().getOwnPropertyNames()) {
