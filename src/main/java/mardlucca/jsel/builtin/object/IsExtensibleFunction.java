/*
 * File: IsExtensibleFunction.java
 *
...
public class IsExtensibleFunction extends JSELFunction {
    public static final String NAME = "isExtensible";

    public IsExtensibleFunction() {
    ...
    public JSELBoolean call(JSELValue aInThis, List<JSELValue> aInArguments,
        ...
        return lArgument.toObject().isExtensible()
                ? JSELBoolean.FALSE
                : JSELBoolean.TRUE;
    }
}
