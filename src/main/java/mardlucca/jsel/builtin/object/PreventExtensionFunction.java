/*
 * File: PreventExtensionFunction.java
 *
...
public class PreventExtensionFunction extends JSELFunction {
    public static final String NAME = "preventExtension";

    public PreventExtensionFunction() {
