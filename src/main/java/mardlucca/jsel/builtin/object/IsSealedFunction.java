...
public class IsSealedFunction extends JSELFunction {
    public static final String NAME = "isSealed";

    public IsSealedFunction() {
    ...
    public JSELBoolean call(JSELValue aInThis, List<JSELValue> aInArguments,
        ...
        for (String lName : lObject.getOwnPropertyNames()) {
            if (lObject.getOwnProperty(lName).isConfigurable()) {
