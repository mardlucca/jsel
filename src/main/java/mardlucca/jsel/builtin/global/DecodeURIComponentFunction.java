...
public class DecodeURIComponentFunction extends JSELFunction {
    public static final String NAME = "decodeURIComponent";

    public DecodeURIComponentFunction() {
        super(NAME);
    }
