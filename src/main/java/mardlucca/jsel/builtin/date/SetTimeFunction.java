...
public class SetTimeFunction extends JSELFunction {
    public static final String NAME = "setTime";

    public SetTimeFunction() {
        super(NAME, Collections.singletonList("time"));
    }
    ...
    public JSELValue call(JSELValue aInThis,
        ...
        lDate.setTime((long) getArgument(aInArguments).toNumber());
