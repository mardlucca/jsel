...
public class SetSecondsFunction extends JSELFunction {
    public static final String NAME = "setSeconds";

    public SetSecondsFunction() {
        this(NAME);
    }

    protected SetSecondsFunction(String aInName) {
        super(aInName, asList("sec", "ms"));
    }
