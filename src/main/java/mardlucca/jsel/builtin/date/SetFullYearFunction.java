...
public class SetFullYearFunction extends JSELFunction {
    public static final String NAME = "setFullYear";

    public SetFullYearFunction() {
        this(NAME);
    }

    protected SetFullYearFunction(String aInName) {
        super(aInName, asList("year", "month", "date"));
    }
