...
public class SetDateFunction extends JSELFunction {
    public static final String NAME = "setDate";

    public SetDateFunction() {
        this(NAME);
    }

    protected SetDateFunction(String aInName) {
        super(aInName, asList("date"));
    }
