/*
 * File: SetMillisecondsFunction.java
 *
...
public class SetMillisecondsFunction extends JSELFunction {
    public static final String NAME = "setMilliseconds";

    public SetMillisecondsFunction() {
        this(NAME);
    }

    protected SetMillisecondsFunction(String aInName) {
        super(aInName, Collections.singletonList("ms"));
    }
