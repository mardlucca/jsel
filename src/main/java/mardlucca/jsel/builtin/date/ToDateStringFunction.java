/*
 * File: ToDateStringFunction.java
 *
...
public class ToDateStringFunction extends JSELFunction {
    public static final String NAME = "toDateString";

    public ToDateStringFunction() {
        this(NAME);
    }

    protected ToDateStringFunction(String aInName) {
        super(aInName);
    }
    ...
    public JSELValue call(JSELValue aInThis,
        ...
        return new JSELString(DateFormat.toDateString(
