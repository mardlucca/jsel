...
public class SetMinutesFunction extends JSELFunction {
    public static final String NAME = "setMinutes";

    public SetMinutesFunction() {
        this(NAME);
    }

    protected SetMinutesFunction(String aInName) {
        super(aInName, asList("min", "sec", "ms"));
    }
