/*
 * File: SignedShiftRightExpression.java
 *
...
public class SignedShiftRightExpression extends BinaryOperatorExpression {
    public SignedShiftRightExpression(
